...
- `paw-cra-strategist` — scripts, copy, research, SEO
- `paw-cra-designer` — images, graphics, visual assets
- `paw-cra-video-producer` — videos, motion graphics
- `paw-cra-account-manager` — packaging, final delivery
